...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgLocaitonPrice.Text = db.Location.Average(x => x.Price).Value.ToString("F2") + "₺";
            ...
            var guideIdNameAysegulCinar = db.Guide.Where(x => x.GuideName == "Ayşegül" && x.GuideSurname == "Çınar").Select(y => y.GuideId).FirstOrDefault();
            lblAysegülCinarLocationCount.Text = db.Location.Where(x => x.GuideId == guideIdNameAysegulCinar).Count().ToString();
        }
    }
}
